...
public class Lua_DG_Tweening_TweenSettingsExtensions : LuaObject {
	...
	static public int SetId_s(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(DG.Tweening.Tween),typeof(int))){
				DG.Tweening.Tween a1;
				checkType(l,1,out a1);
				System.Int32 a2;
				checkType(l,2,out a2);
			...
			else if(matchType(l,argc,1,typeof(DG.Tweening.Tween),typeof(string))){
				DG.Tweening.Tween a1;
				checkType(l,1,out a1);
				System.String a2;
				checkType(l,2,out a2);
			...
			else if(matchType(l,argc,1,typeof(DG.Tweening.Tween),typeof(System.Object))){
				DG.Tweening.Tween a1;
				checkType(l,1,out a1);
				System.Object a2;
				checkType(l,2,out a2);
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function SetId to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int SetLink_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			if(argc==2){
				...
				checkType(l,2,out a2);
				var ret=DG.Tweening.TweenSettingsExtensions.SetLink<DG.Tweening.Tween>(a1,a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				UnityEngine.GameObject a2;
				checkType(l,2,out a2);
				DG.Tweening.LinkBehaviour a3;
				a3 = (DG.Tweening.LinkBehaviour)LuaDLL.luaL_checkinteger(l, 3);
				var ret=DG.Tweening.TweenSettingsExtensions.SetLink<DG.Tweening.Tween>(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function SetLink to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int SetLoops_s(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				a3 = (DG.Tweening.LoopType)LuaDLL.luaL_checkinteger(l, 3);
	...
	static public int SetEase_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(DG.Tweening.Tween),typeof(DG.Tweening.EaseFunction))){
				...
				checkType(l,1,out a1);
				DG.Tweening.Ease a2;
				a2 = (DG.Tweening.Ease)LuaDLL.luaL_checkinteger(l, 2);
				var ret=DG.Tweening.TweenSettingsExtensions.SetEase<DG.Tweening.Tween>(a1,a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
	...
	static public int SetUpdate_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(DG.Tweening.Tween),typeof(DG.Tweening.UpdateType))){
				...
				a2 = (DG.Tweening.UpdateType)LuaDLL.luaL_checkinteger(l, 2);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int SetInverted_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			if(argc==1){
				DG.Tweening.Tween a1;
				checkType(l,1,out a1);
				var ret=DG.Tweening.TweenSettingsExtensions.SetInverted<DG.Tweening.Tween>(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				System.Boolean a2;
				checkType(l,2,out a2);
				var ret=DG.Tweening.TweenSettingsExtensions.SetInverted<DG.Tweening.Tween>(a1,a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function SetInverted to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int From_s(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				System.Boolean a3;
				checkType(l,3,out a3);
				var ret=DG.Tweening.TweenSettingsExtensions.From<DG.Tweening.Tweener>(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			else if(matchType(l,argc,1,typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.CircleOptions>),typeof(float),typeof(bool),typeof(bool))){
				DG.Tweening.Core.TweenerCore<UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.CircleOptions> a1;
				checkType(l,1,out a1);
				System.Single a2;
				checkType(l,2,out a2);
				System.Boolean a3;
				...
				System.Boolean a4;
				checkType(l,4,out a4);
				var ret=DG.Tweening.TweenSettingsExtensions.From(a1,a2,a3,a4);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			else if(matchType(l,argc,1,typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions>),typeof(float),typeof(bool),typeof(bool))){
			...
			else if(matchType(l,argc,1,typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions>),typeof(float),typeof(bool),typeof(bool))){
	...
	static public int SetDelay_s(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Boolean a3;
				checkType(l,3,out a3);
				var ret=DG.Tweening.TweenSettingsExtensions.SetDelay<DG.Tweening.Tween>(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function SetDelay to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int SetOptions_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions>),typeof(bool))){
				...
				a2 = (DG.Tweening.AxisConstraint)LuaDLL.luaL_checkinteger(l, 2);
				System.Boolean a3;
				checkType(l,3,out a3);
				...
				a3 = (DG.Tweening.AxisConstraint)LuaDLL.luaL_checkinteger(l, 3);
				var ret=DG.Tweening.TweenSettingsExtensions.SetOptions(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
				...
				a4 = (DG.Tweening.AxisConstraint)LuaDLL.luaL_checkinteger(l, 4);
				...
				a3 = (DG.Tweening.ScrambleMode)LuaDLL.luaL_checkinteger(l, 3);
				System.String a4;
				checkType(l,4,out a4);
				var ret=DG.Tweening.TweenSettingsExtensions.SetOptions(a1,a2,a3,a4);
				pushValue(l,true);
	...
	static public int SetLookAt_s(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions>),typeof(UnityEngine.Transform),typeof(bool))){
				DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions> a1;
				checkType(l,1,out a1);
				...
				System.Boolean a3;
				checkType(l,3,out a3);
				var ret=DG.Tweening.TweenSettingsExtensions.SetLookAt(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			else if(matchType(l,argc,1,typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions>),typeof(UnityEngine.Vector3),typeof(bool))){
				DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions> a1;
				checkType(l,1,out a1);
			...
			else if(matchType(l,argc,1,typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions>),typeof(float),typeof(bool))){
				DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions> a1;
				checkType(l,1,out a1);
				System.Single a2;
				checkType(l,2,out a2);
			...
			else if(matchType(l,argc,1,typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions>),typeof(float),typeof(System.Nullable<UnityEngine.Vector3>),typeof(System.Nullable<UnityEngine.Vector3>))){
				DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions> a1;
				checkType(l,1,out a1);
				System.Single a2;
				checkType(l,2,out a2);
