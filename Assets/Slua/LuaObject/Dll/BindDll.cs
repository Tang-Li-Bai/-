	...
	public class BindDll {
		public static Action<IntPtr>[] GetBindList() {
			Action<IntPtr>[] list= {
				...
				Lua_DG_Tweening_LinkBehaviour.reg,
				...
				Lua_DG_Tweening_Plugins_CircleOptions.reg,
				Lua_DG_Tweening_Plugins_CirclePlugin.reg,
				...
				Lua_DG_Tweening_Plugins_Options_IPlugOptions.reg,
				...
				Lua_DG_Tweening_Core_DOTweenExternalCommand.reg,
				Lua_DG_Tweening_Core_DOTweenUtils.reg,
				Lua_DG_Tweening_Core_Enums_NestedTweenFailureBehaviour.reg,
				Lua_DG_Tweening_Core_Enums_SafeModeLogBehaviour.reg,
				Lua_DG_Tweening_Core_Enums_SpecialStartupMode.reg,
				Lua_DG_Tweening_Core_Enums_UpdateNotice.reg,
				Lua_DG_Tweening_Core_Enums_RewindCallbackMode.reg,
				...
				Lua_DG_Tweening_DOCurve_CubicBezier.reg,
				Lua_DG_Tweening_Core_DOTweenSettings_SettingsLocation.reg,
				Lua_DG_Tweening_Core_DOTweenSettings_SafeModeOptions.reg,
				Lua_DG_Tweening_Core_DOTweenSettings_ModulesSetup.reg,
			};
			return list;
		}
	}
