...
public class Lua_DG_Tweening_Plugins_CirclePlugin : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			#endif
			#endif
			DG.Tweening.Plugins.CirclePlugin o;
			o=new DG.Tweening.Plugins.CirclePlugin();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Reset(IntPtr l) {
		try {
			...
			#endif
			#endif
			DG.Tweening.Plugins.CirclePlugin self=(DG.Tweening.Plugins.CirclePlugin)checkSelf(l);
	...
	static public int GetSpeedBasedDuration(IntPtr l) {
		try {
			...
			#endif
			DG.Tweening.Plugins.CirclePlugin self=(DG.Tweening.Plugins.CirclePlugin)checkSelf(l);
			DG.Tweening.Plugins.CircleOptions a1;
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetPositionOnCircle(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Single a2;
			checkType(l,3,out a2);
			var ret=self.GetPositionOnCircle(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int Get_s(IntPtr l) {
		try {
			...
			#endif
			#endif
			var ret=DG.Tweening.Plugins.CirclePlugin.Get();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.CirclePlugin");
		addMember(l,Reset);
		addMember(l,SetFrom);
		...
		addMember(l,GetPositionOnCircle);
		addMember(l,Get_s);
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.CirclePlugin),typeof(DG.Tweening.Plugins.Core.ABSTweenPlugin<UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.CircleOptions>));
	}
}
