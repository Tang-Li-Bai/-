...
public class Lua_DG_Tweening_Core_Debugger : LuaObject {
	...
	static public int LogWarning_s(IntPtr l) {
		try {
			...
			DG.Tweening.Core.Debugger.LogWarning(a1,a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int LogError_s(IntPtr l) {
		try {
			...
			DG.Tweening.Tween a2;
			checkType(l,2,out a2);
			DG.Tweening.Core.Debugger.LogError(a1,a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int LogSafeModeCapturedError_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			DG.Tweening.Tween a2;
			checkType(l,2,out a2);
			DG.Tweening.Core.Debugger.LogSafeModeCapturedError(a1,a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int LogSafeModeReport_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Object a1;
			checkType(l,1,out a1);
			DG.Tweening.Core.Debugger.LogSafeModeReport(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int LogMissingMaterialProperty_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function LogMissingMaterialProperty to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int LogRemoveActiveTweenError_s(IntPtr l) {
		try {
			...
			DG.Tweening.Tween a2;
			checkType(l,2,out a2);
			DG.Tweening.Core.Debugger.LogRemoveActiveTweenError(a1,a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int LogAddActiveTweenError_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			DG.Tweening.Tween a2;
			checkType(l,2,out a2);
			DG.Tweening.Core.Debugger.LogAddActiveTweenError(a1,a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int SetLogPriority_s(IntPtr l) {
		try {
			...
			a1 = (DG.Tweening.LogBehaviour)LuaDLL.luaL_checkinteger(l, 1);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ShouldLogSafeModeCapturedError_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			#endif
			var ret=DG.Tweening.Core.Debugger.ShouldLogSafeModeCapturedError();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,LogSafeModeCapturedError_s);
		addMember(l,LogReport_s);
		addMember(l,LogSafeModeReport_s);
		...
		addMember(l,LogAddActiveTweenError_s);
		addMember(l,SetLogPriority_s);
		addMember(l,ShouldLogSafeModeCapturedError_s);
		addMember(l,"logPriority",get_logPriority,null,false);
