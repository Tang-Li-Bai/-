...
public class Lua_DG_Tweening_TweenExtensions : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GotoWithCallbacks_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Boolean a3;
			checkType(l,3,out a3);
			DG.Tweening.TweenExtensions.GotoWithCallbacks(a1,a2,a3);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ManualUpdate_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Single a3;
			checkType(l,3,out a3);
			DG.Tweening.TweenExtensions.ManualUpdate(a1,a2,a3);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int Restart_s(IntPtr l) {
		try {
			...
			System.Single a3;
			checkType(l,3,out a3);
			DG.Tweening.TweenExtensions.Restart(a1,a2,a3);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ElapsedDelay_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			DG.Tweening.Tween a1;
			checkType(l,1,out a1);
			var ret=DG.Tweening.TweenExtensions.ElapsedDelay(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,Goto_s);
		addMember(l,GotoWithCallbacks_s);
		addMember(l,Kill_s);
		addMember(l,ManualUpdate_s);
		addMember(l,Pause_s);
		addMember(l,Play_s);
