...
public class Lua_DG_Tweening_DOTween : LuaObject {
	...
	static public int ManualUpdate_s(IntPtr l) {
		try {
			...
			System.Single a2;
			checkType(l,2,out a2);
			DG.Tweening.DOTween.ManualUpdate(a1,a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int ToAxis_s(IntPtr l) {
		try {
			...
			a5 = (DG.Tweening.AxisConstraint)LuaDLL.luaL_checkinteger(l, 5);
	...
	static public int Sequence_s(IntPtr l) {
		try {
			...
			if(argc==0){
				...
				System.Object a1;
				checkType(l,1,out a1);
				var ret=DG.Tweening.DOTween.Sequence(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function Sequence to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int Kill_s(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Boolean a3;
				checkType(l,3,out a3);
				var ret=DG.Tweening.DOTween.Kill(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function Kill to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int Restart_s(IntPtr l) {
		try {
			...
			if(argc==3){
				...
				System.Single a4;
				checkType(l,4,out a4);
				var ret=DG.Tweening.DOTween.Restart(a1,a2,a3,a4);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public int IsTweening_s(IntPtr l) {
		try {
			...
			System.Boolean a2;
			checkType(l,2,out a2);
			var ret=DG.Tweening.DOTween.IsTweening(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int TotalActiveTweens_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			#endif
			var ret=DG.Tweening.DOTween.TotalActiveTweens();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int PlayingTweens_s(IntPtr l) {
		try {
			...
			#endif
			#endif
			System.Collections.Generic.List<DG.Tweening.Tween> a1;
			checkType(l,1,out a1);
			var ret=DG.Tweening.DOTween.PlayingTweens(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int PausedTweens_s(IntPtr l) {
		try {
			...
			System.Collections.Generic.List<DG.Tweening.Tween> a1;
			checkType(l,1,out a1);
			var ret=DG.Tweening.DOTween.PausedTweens(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int TweensById_s(IntPtr l) {
		try {
			...
			System.Boolean a2;
			checkType(l,2,out a2);
			System.Collections.Generic.List<DG.Tweening.Tween> a3;
			checkType(l,3,out a3);
			var ret=DG.Tweening.DOTween.TweensById(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int TweensByTarget_s(IntPtr l) {
		try {
			...
			System.Collections.Generic.List<DG.Tweening.Tween> a3;
			checkType(l,3,out a3);
			var ret=DG.Tweening.DOTween.TweensByTarget(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_safeModeLogBehaviour(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)DG.Tweening.DOTween.safeModeLogBehaviour);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_safeModeLogBehaviour(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			DG.Tweening.DOTween.safeModeLogBehaviour=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_nestedTweenFailureBehaviour(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)DG.Tweening.DOTween.nestedTweenFailureBehaviour);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_nestedTweenFailureBehaviour(IntPtr l) {
		try {
			...
			DG.Tweening.DOTween.nestedTweenFailureBehaviour=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_maxSmoothUnscaledTime(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,DG.Tweening.DOTween.maxSmoothUnscaledTime);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_maxSmoothUnscaledTime(IntPtr l) {
		try {
			...
			System.Single v;
			checkType(l,2,out v);
			DG.Tweening.DOTween.maxSmoothUnscaledTime=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onWillLog(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			#endif
			System.Func<UnityEngine.LogType,System.Object,System.Boolean> v;
			int op=checkDelegate(l,2,out v);
			if(op==0) DG.Tweening.DOTween.onWillLog=v;
			else if(op==1) DG.Tweening.DOTween.onWillLog+=v;
			else if(op==2) DG.Tweening.DOTween.onWillLog-=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_debugMode(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,DG.Tweening.DOTween.debugMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_debugMode(IntPtr l) {
		try {
			...
			System.Boolean v;
			checkType(l,2,out v);
			DG.Tweening.DOTween.debugMode=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_instance(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,DG.Tweening.DOTween.instance);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_instance(IntPtr l) {
		try {
			...
			#endif
			#endif
			DG.Tweening.Core.DOTweenComponent v;
			checkType(l,2,out v);
			DG.Tweening.DOTween.instance=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_debugStoreTargetId(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,DG.Tweening.DOTween.debugStoreTargetId);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_debugStoreTargetId(IntPtr l) {
		try {
			...
			bool v;
			checkType(l,2,out v);
			DG.Tweening.DOTween.debugStoreTargetId=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,TotalActiveTweens_s);
		...
		addMember(l,"safeModeLogBehaviour",get_safeModeLogBehaviour,set_safeModeLogBehaviour,false);
		addMember(l,"nestedTweenFailureBehaviour",get_nestedTweenFailureBehaviour,set_nestedTweenFailureBehaviour,false);
		...
		addMember(l,"maxSmoothUnscaledTime",get_maxSmoothUnscaledTime,set_maxSmoothUnscaledTime,false);
		addMember(l,"onWillLog",null,set_onWillLog,false);
		addMember(l,"drawGizmos",get_drawGizmos,set_drawGizmos,false);
		addMember(l,"debugMode",get_debugMode,set_debugMode,false);
		...
		addMember(l,"debugStoreTargetId",get_debugStoreTargetId,set_debugStoreTargetId,false);
